  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Se muestra una lista del historial de acciones que han habido en el sistema, indicando el usuario que hizo la accion, la hora y fecha en la que se hizo, ademas de indicar que tabla de la base de datos fue la que recibió la acción.
      </div>
