...
<body> 
  ...
  <div class="container">
    ...
    <div class="tabla" id="form" data-eliminar="eliminarTrabajos_extras">
          ...
          <table id="datatableid">
            ...
            <tbody id="tbody-trabajos_extras">
              ...
              <tr id="fila-<?php echo $trabajos_extras->getId(); ?>">
               ...
               <td>  
                  <a class="crud" href="<?php echo constant('URL')?>trabajos_extras/exportar/<?php echo $trabajos_extras->getId();?>" target="_blank">Generar</a>
                </td>     
                <td>
