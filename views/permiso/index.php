...
<body>
  ...
  <div class="container">
    ...
    <div class="tabla" id="form" data-eliminar="eliminarPermiso">
      <div>
          <table id="datatableid">
            ...
            <tbody id="tbody-permiso">
              ...
              <tr id="fila-<?php echo $permiso->getId(); ?>">
                <td><?php echo $permiso->getNombre(); ?></td>
                <td><?php echo $permiso->getApellido(); ?></td>
                <td><?php echo $permiso->getCedula(); ?></td>
                <td><?php echo $permiso->getDesde(); ?></td> 
                <td><?php echo $permiso->getHasta(); ?></td>  
                <td><?php echo $permiso->getDescripcion(); ?></td>     
                <td>  
                   <a class="crud editar" href="<?php echo constant('URL')?>permiso/mostrar/<?php echo $permiso->getId();?>">Modificar</a>
                </td>

                <td>
                  <button class="crud eliminar" data-id="<?php echo $permiso->getId(); ?>">Eliminar</button>
                </td>
              </tr>
              <?php } ?>
            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       Se muestra una lista de todos los permisos registrados en el sistema.
      </div>
...
<div class="modal fade" id="registrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <?php require 'views/permiso/agregar.php'; ?> 
</div>
...
<div class="modal fade" id="modal_actualizar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <?php require 'views/permiso/actualizar_modal.php'; ?> 
</div>
  ...
  <script src="<?php echo constant('URL')?>public/js/main.js"></script>
   ...
   <script src="<?php echo constant('URL')?>public/js/AJAX/permiso.js"></script>
