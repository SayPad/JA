  ...
  <div class="container">
    ...
    <main>
        ...
        <div class="text-header">
            <h2>Gestion de Cargos</h2> 
        </div>

    <div class="tabla" id="form" data-eliminar="eliminarCargo">
      <div>
          <table id="datatableid">
            ...
            <tbody id="tbody-cargo">
              <?php
                foreach($this->cargo as $row){
                  $cargo = new CargoClass();
                  $cargo = $row;
              ?>
               
              <tr id="fila-<?php echo $cargo->getId(); ?>">
                <td><?php echo $cargo->getNombre_cargo(); ?></td>
                <td><?php echo $cargo->getSueldo(). " Bs"; ?></td>
                <td><?php echo $cargo->getPrima() . " Bs"; ?></td>     
                <td>  
                  <a class="crud editar" href="<?php echo constant('URL')?>cargo/mostrar/<?php echo $cargo->getId();?>">Modificar</a>
                </td>

                <td>
                  <button class="crud eliminar" data-id="<?php echo $cargo->getId(); ?>">Eliminar</button>
                </td>
              </tr>
              <?php } ?>
            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Se muestra una lista de todos los cargos activos registrados en la base de datos, los cuales se pueden modificar y eliminar. ademas de registrar un cargo nuevo.
      </div>
...
<div class="modal fade" id="registrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <?php require 'views/cargo/agregar.php'; ?> 
</div>
...
<div class="modal fade" id="modal_actualizar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <?php require 'views/cargo/actualizar_modal.php'; ?> 
</div>
    </main>
  </div>
  ...
  <script src="<?php echo constant('URL')?>public/js/main.js"></script>
   ...
   <script src="<?php echo constant('URL')?>public/js/AJAX/cargos.js"></script>
