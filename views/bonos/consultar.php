          ...
          <table id="datatableid">
            ...
            <tbody id="tbody-bonos">
              ...
              <tr id="fila-<?php echo $bonos->getId(); ?>">
                ...
                ?></td> 
               <td>  
                  <a class="crud" href="<?php echo constant('URL')?>bonos/exportar/<?php echo $bonos->getId();?>">Generar</a>
                </td>     
                <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Se muestra una lista de los recibos de CestaTicket de los trabajadores, que se han registrado en el sistema, con las opciones de generar el pdf y eliminar cada uno de ellos. ademas de la opcion de registrar un recibo nuevo.
      </div>
...
<div class="modal fade" id="generarRecibo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <script src="<?php echo constant('URL')?>public/js/main.js"></script>
   ...
   <script src="<?php echo constant('URL')?>public/js/AJAX/cestaticket.js"></script>
